...
null_ds = [
    ("key1", 1000, 77.3, "value1", datetime(2022, 10, 15, 10, 3, 2), None),
...
null_ds_types = ["String", "Nullable(Int32)", "Nullable(Float64)", "Nullable(String)", "Nullable(DateTime)", "Nullable(Date)"]

basic_ds = [
    ("key1", 1000, 50.3, "value1", datetime.now(), "lc_1"),
...
dt_ds = [datetime(2020, 10, 10), datetime(2021, 11, 11)]
