...
from tests.helpers import random_columns, random_data, native_transform, native_insert_block, bytes_response
...
def test_native_round_trips():
    for _ in range(TEST_RUNS):
        ...
        data_result = native_transform.parse_response(bytes_response(output))
