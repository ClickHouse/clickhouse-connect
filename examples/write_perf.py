...
inserts = [
    {
        "query": "SELECT trip_id, pickup, dropoff, pickup_longitude, " + "pickup_latitude FROM taxis ORDER BY trip_id LIMIT 5000000",
        "columns": "trip_id UInt32, pickup String, dropoff String," + " pickup_longitude Float64, pickup_latitude Float64",
    },
    {"query": "SELECT number from numbers(5000000)", "columns": "number UInt64"},
]
