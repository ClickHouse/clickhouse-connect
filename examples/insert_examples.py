...
"""
    ...
    data = [[1, ["string_1", "string_2"], [20, 30]], [2, ["string_3", "string_4"], [40, 50]]]
    client.insert(
        "test_nested_flat",
        data,
...
"""
    ...
    data = [
        [1, [{"str": "nested_string_1", "int32": 20}, {"str": "nested_string_2", "int32": 30}]],
        [2, [{"str": "nested_string_3", "int32": 40}, {"str": "nested_string_4", "int32": 50}]],
    ]
    client.insert(
        "test_nested_not_flat", data, column_names=["key", "value"], column_type_names=["UInt32", "Nested(str String, int32 Int32)"]
    )
