...
## UNRELEASED
- Added support for pyarrow-backed dtypes when using pandas 2.x. Toggle with common setting called `pandas_dtype_backend`, options are "numpy" (default) and "pyarrow". Closes [#326](https://github.com/ClickHouse/clickhouse-connect/issues/326)
