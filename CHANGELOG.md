...
- Native inserts of `QBit` columns with a dimension greater than 8 no longer corrupt the vector. Closes [#866](https://github.com/ClickHouse/clickhouse-connect/issues/866).
